...
/*
 * Return a string contains formatted output, one per line, of the usernames 
 * of all users in the list starting at curr.
 */
...
/*
 * Return a user profile string.
 * For an example of the required output format, see the example output
 * linked from the handout.
 * Return:
 *   - return string on success.
 *   - NULL if the user is NULL.
 */
